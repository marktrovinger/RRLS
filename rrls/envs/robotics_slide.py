...
class RobustSlide(Wrapper):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        super().__init__(env = gym.make("FetchSlide-v4", **kwargs))
        self.set_params()
...
class RobustSlideDense(Wrapper):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        super().__init__(env = gym.make("FetchSlideDense-v4", **kwargs))
        self.set_params()
